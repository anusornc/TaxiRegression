...
namespace SampleRegression.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"/Users/anusornchaikaew/Work/MLNet/TaxiRegression/taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=323,MinimumExampleCountPerLeaf=2,NumberOfTrees=785,MaximumBinCountPerFeature=380,FeatureFraction=0.6282803442051389,LearningRate=0.05505857704872027,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",DiskTranspose=false}));
